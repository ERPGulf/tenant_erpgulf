...
def get_customer_maintenance_data(customer_id):
    ...
    try:
        mr_meta = frappe.get_meta("Maintenance Request")
    ...
    # ── Hide "Common Area" unless this customer has access ────────
    has_common_area_access = frappe.db.get_value(
        "Customer", customer_id, "custom_common_area_access"
    )
