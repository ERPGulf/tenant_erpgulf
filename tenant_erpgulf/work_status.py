...
#     quotation_submitted     = False   # ← NEW: tracks if quotation is submitted
...
#                     "Quotation",
#                     custom_quotation,
#                     ["grand_total", "modified", "custom_quotation_status", "docstatus"],  # ← added docstatus
#                     as_dict=True,
#                 )
#                 if quotation_data:
...
#                     quotation_submitted     = quotation_data.get("docstatus") == 1  # ← NEW: True only if submitted
...
#             "completed":   bool(custom_quotation) and quotation_submitted,  # ← CHANGED: must be submitted
